L.Control.Window = L.Control.extend({
    ...
    initialize: function (container, options) {
        ...
        //BADU: Added "control-window-" as prefix to styles to avoid conflicts 
        this._containerTitleBar = L.DomUtil.create('div', 'control-window-titlebar',this._container);
        this.titleContent = L.DomUtil.create('h2', 'control-window-title',this._containerTitleBar);
        this._containerContent =  L.DomUtil.create('div', 'control-window-content' ,this._container);
        this._containerPromptButtons =  L.DomUtil.create('div', 'control-window-promptButtons' ,this._container);

        if (this.options.closeButton) {
            this._closeButton = L.DomUtil.create('a', 'control-window-close',this._containerTitleBar);
